...
- Serves a single-page demo application with branding presets for 7 CRMs (Salesforce, ServiceNow, HubSpot, Zendesk, Microsoft Dynamics, Halo, and a generic CRM)
